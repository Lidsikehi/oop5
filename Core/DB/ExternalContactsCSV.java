...
public class ExternalContactsCSV implements ExternalData {
    private static final String CSV_HEADER = "имя;электронная почта;телефоны\n";
    private static final String CSV_DELIMITER = ";";
    private static final String CANNOT_READ_FILE_MSG = "Не удается прочитать файл базы данных, будет использоваться пустой телефон";
    private static final String EMPTY_FILE_MSG = "Найдена пустая телефонная книга";
    private static final String BAD_FILE_MSG = "Файл базы данных поврежден, некоторые контакты могут быть потеряны";
    private static final String CANNOT_WRITE_FILE_MSG = "Не удается сохранить файл базы данных...";
